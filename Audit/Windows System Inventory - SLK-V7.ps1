...
$sheet5.Cells.Item(1,1) = "Computer"
$sheet5.Cells.Item(1,2) = "Application"
...
#Service details
$sheet7 = $workbook.worksheets.item(7)
$sheet7.Name = 'Service Details'
$sheet7.Rows.Item(1).Font.Bold = $true
$sheet7.Cells.Item(1,1) = "Computer"
$sheet7.Cells.Item(1,2) = "Name"
$sheet7.Cells.Item(1,3) = "Caption" 
$sheet7.Cells.Item(1,4) = "State" 
$sheet7.Cells.Item(1,5) = "Startmode"
$sheet7.Cells.Item(1,6) = "Pathname"
$sheet7.Cells.Item(1,7) = "Run as"
...
#network details
write-host "Processing Network Details"  -ForegroundColor Green
...
$serviceinfo = $null
$Serviceinfo1 = $null
$serviceinfo = Get-CimInstance -ClassName win32_service -CimSession $Session #| where {$_.startmode -match "disabled"}
...
{
For($i = 1; $i -le $serviceinfo.count; $i++)
{Write-Progress -Activity "Gathering Services" -Status "Processing Service:  $serviceinfo1.name" -PercentComplete ($i / $serviceinfo.Count*100)}

$sheet7column = 1
$sheet7.Cells.Item($sheet7row, $sheet7column) = $computer
$sheet7column++
$sheet7.Cells.Item($sheet7row, $sheet7column) = $Serviceinfo1.Name
$sheet7column++
$sheet7.Cells.Item($sheet7row, $sheet7column) = $Serviceinfo1.Caption
$sheet7column++
$sheet7.Cells.Item($sheet7row, $sheet7column) = $Serviceinfo1.State
$sheet7column++
$sheet7.Cells.Item($sheet7row, $sheet7column) = $Serviceinfo1.StartMode
$sheet7column++
$sheet7.Cells.Item($sheet7row, $sheet7column) = $Serviceinfo1.Pathname
$sheet7column++
$sheet7.Cells.Item($sheet7row, $sheet7column) = $Serviceinfo1.startname
$sheet7column++
$sheet7row++
} 
$usedRange1 = $sheet7.UsedRange
$usedRange1.EntireColumn.AutoFit() | Out-Null

#Miscellenious Details
write-host "Processing Miscellenious Details"  -ForegroundColor Green
...
write-host "Processing Application Details"  -ForegroundColor Green
$apps = $apps123 | sort
foreach ($app in $apps) {
if ($app -ne $null)  {
$appscolumn = 1
$sheet5.Cells.Item($appsrow, $appscolumn) = $computer
$appscolumn++
