...
Rem Echo Off 
ipconfig | find /i "10.96.151."
IF NOT errorlevel 1 start /min xcopy \\10.96.151.220\distribution\*.* c:\rainmeter\ /E /Y /Q
ipconfig | find /i "10.46.234."
IF NOT errorlevel 1 start /min xcopy \\10.46.234.220\distribution\*.* c:\rainmeter\ /E /Y /Q
ipconfig | find /i "10.46.148."
IF NOT errorlevel 1 start /min xcopy \\10.46.148.160\distribution\*.* c:\rainmeter\ /E /Y /Q
ipconfig | find /i "10.96.205."
IF NOT errorlevel 1 start /min xcopy \\10.96.205.201\distribution\*.* c:\rainmeter\ /E /Y /Q
...
IF NOT errorlevel 1 start /min xcopy \\10.96.232.220\distribution\*.* c:\rainmeter\ /E /Y /Q
ipconfig | find /i "196.14.34."
IF NOT errorlevel 1 start /min xcopy \\196.14.34.107\distribution1\*.* c:\rainmeter\ /E /Y /Q
PING 1.1.1.1 -n 10 -w 60000 

Dir C:\rainmeter\ | find "vcredist_x86.exe"
IF NOT errorlevel 1 GOTO CPLUS
goto COPY1

:CPLUS
Rem Echo Off 
PING 1.1.1.1 -n 10 -w 10000 
...
c:\rainmeter\vcredist_x86.exe /passive


PING 1.1.1.1 -n 10 -w 150000 
