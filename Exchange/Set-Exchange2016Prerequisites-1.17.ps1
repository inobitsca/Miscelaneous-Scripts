...
#    Change Log			: 1.17 - Added Windows Defender
...
#																																								   #
# DATE RELEASED         : 10/01/15 (06/19/2019 - Last Update)  																			                           #
#																																								   #
...
#																																								   #
# EXECUTION																																						   #
#. \Set-Exchange2016Prerequisites-1.16.ps1																														   #
#																																								   #
####################################################################################################################################################################
...
Function Install-NET472 {
    # VerIfy .NET 4.7.2 is not already installed
    Check-DotNetVersion
    ...
    If ($DotNetVersion -lt 461814) {
        ...
        # Old Code (Removed)
        # [string]$expression = ".\NDP472-KB4054530-x86-x64-AllOS-ENU.exe /quiet /norestart /l* $DownloadFolder\DotNET472.log"
        # Invoke-Expression $Expression | Out-Null
        # Start-Sleep -Seconds 60

        Write-Host "`n.NET 4.7.2 is now installed" -ForegroundColor Green
        Write-Host " "
        $Reboot = $true

    } 
    start-sleep 2
} # End of Install-NET472 Function
...
$Menu2012 = {
    ...
    Write-Host "	**********************************************************************" -ForegroundColor Cyan
    Write-Host " "
    Write-Host "	.NET UPDATE - Default is .NET 4.7.2" -ForegroundColor Red
    Write-Host "	*** Use Option 21 for .NET 4.8 prior to any other options ***" -ForegroundColor Yellow
    Write-Host " "
    ...
    Write-Host "	20) Install - One-Off - .NET 4.7.2 - CU11+" -ForegroundColor White
    Write-Host "	21) Install - One-Off - .NET 4.8 - CU13+" -ForegroundColor White
    Write-Host "	22) Install - One-Off - Windows Features [MBX]" -ForegroundColor White
    Write-Host "	23) Install - One Off - Unified Communications Managed API 4.0" -ForegroundColor White
    Write-Host "	24) Install - One Off - Microsoft C++ 2013 (CU11+)" -ForegroundColor White
    Write-Host "	25) Install - One Off - Microsoft C++ 2012 (Edge Transport)" -ForegroundColor White
    Write-Host "	"
...
##### All other options #####
    ...
    22 {#	Install -One-Off - Windows Features [MBX]
        ModuleStatus -name ServerManager
        Install-WindowsFeature AS-HTTP-Activation, Desktop-Experience, NET-Framework-45-Features, RPC-over-HTTP-proxy, RSAT-Clustering, RSAT-Clustering-CmdInterface, RSAT-Clustering-Mgmt, RSAT-Clustering-PowerShell, Web-Mgmt-Console, WAS-Process-Model, Web-Asp-Net45, Web-Basic-Auth, Web-Client-Auth, Web-Digest-Auth, Web-Dir-Browsing, Web-Dyn-Compression, Web-Http-Errors, Web-Http-Logging, Web-Http-Redirect, Web-Http-Tracing, Web-ISAPI-Ext, Web-ISAPI-Filter, Web-Lgcy-Mgmt-Console, Web-Metabase, Web-Mgmt-Console, Web-Mgmt-Service, Web-Net-Ext45, Web-Request-Monitor, Web-Server, Web-Stat-Compression, Web-Static-Content, Web-Windows-Auth, Web-WMI, Windows-Identity-Foundation
    }
    ...
    24 {# Install - One Off - C++ 2013 - CU11+
        CPlusPlus2013
    }
    25 {# Install - One Off - C++ 2012 - Edge Transport
        CPlusPlus2012
    }
...
$Menu2016 = {
    ...
    Write-Host "	23) Install - One Off - Unified Communications Managed API 4.0" -ForegroundColor White
    Write-Host "	24) Install - One Off - Microsoft C++ 2013 (CU11+)" -ForegroundColor White
    Write-Host "	25) Install - One Off - Microsoft C++ 2012 (CU11+)" -ForegroundColor White
    Write-Host "	26) Configure TCP Keep ALive (1800000) [All Roles]"	 -ForegroundColor White
    Write-Host "	"
...
Do { 	
  ...
  switch ($Choice)    {
    ...
    20 {#	Install -One-Off - .NET 4.7.2
        Install-NET472
    }
    21 {#	Install -One-Off - .NET 4.8
        Install-NET48
    }
    22 {#	Install -One-Off - Windows Features [MBX] - CU3+
        ModuleStatus -name ServerManager
        Install-WindowsFeature NET-Framework-45-Features, RPC-over-HTTP-proxy, RSAT-Clustering, RSAT-Clustering-CmdInterface, RSAT-Clustering-Mgmt, RSAT-Clustering-PowerShell, Web-Mgmt-Console, WAS-Process-Model, Web-Asp-Net45, Web-Basic-Auth, Web-Client-Auth, Web-Digest-Auth, Web-Dir-Browsing, Web-Dyn-Compression, Web-Http-Errors, Web-Http-Logging, Web-Http-Redirect, Web-Http-Tracing, Web-ISAPI-Ext, Web-ISAPI-Filter, Web-Lgcy-Mgmt-Console, Web-Metabase, Web-Mgmt-Console, Web-Mgmt-Service, Web-Net-Ext45, Web-Request-Monitor, Web-Server, Web-Stat-Compression, Web-Static-Content, Web-Windows-Auth, Web-WMI, Windows-Identity-Foundation
    }
    23 {#	Install - One Off - Unified Communications Managed API 4.0 - CU3+
        Install-WinUniComm4
    }
    24 {# Install - One Off - C++ 2013 - CU11+
        CPlusPlus2013
    ...
    26 { # Configure TCP Keep Alive Value to 1800000
        ConfigureTCPKeepAlive
    }
    30 {#	Set power plan to High Performance as per Microsoft
        HighPerformance
