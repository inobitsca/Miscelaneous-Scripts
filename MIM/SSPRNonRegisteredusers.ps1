...
$UserRegName = (($Object.ResourceManagementObject.ResourceManagementAttributes | Where-Object {$_.AttributeName -eq "/person[AuthNWFRegistered]"}).Value)

 $ResetPass | Add-Member NoteProperty "AuthNWFRegistered" $UserRegName
